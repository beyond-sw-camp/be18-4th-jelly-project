...
public class ItemServiceImpl implements ItemService {
    ...
    public PageResponse<ItemListResponse> searchItems(final SearchItemRequest keyword, final Pageable pageable) {
        return PageResponse.from(itemRepository.searchItems(keyword, pageable).map(ItemListResponse::fromEntity));
    }
    ...
    public Item findItemByName(final String name) {
        return itemRepository.findByName(name).orElseThrow(() -> new CustomException(ErrorCode.ITEM_NOT_FOUND));
    }
    ...
    public Item findItemByRfid(final String rfid) {
        return itemRepository.findByRfid(rfid).orElseThrow(() -> new CustomException(ErrorCode.ITEM_RFID_REQUIRED));
    }
    ;
