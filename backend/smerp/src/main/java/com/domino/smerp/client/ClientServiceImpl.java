...
public class ClientServiceImpl implements ClientService {
    ...
    public PageResponse<ClientListResponse> searchClients(
            String companyName, String businessNumber, Pageable pageable) {

        BooleanExpression companyNameCondition = (companyName != null && !companyName.isEmpty())
                ? QClient.client.companyName.startsWith(companyName)
                : null;

        BooleanExpression businessNumberCondition = (businessNumber != null && !businessNumber.isEmpty())
                ? QClient.client.businessNumber.startsWith(businessNumber)
                : null;
        ...
        Page<Client> page = (condition == null)
