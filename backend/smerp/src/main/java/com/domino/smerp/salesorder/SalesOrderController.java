...
public class SalesOrderController {
    ...
    // 판매 등록
    @PostMapping
    public ResponseEntity<CreateSalesOrderResponse> createSalesOrder(@RequestBody CreateSalesOrderRequest request) {
    ...
    public ResponseEntity<PageResponse<ListSalesOrderResponse>> getSalesOrders(
            SearchSalesOrderRequest condition, Pageable pageable) {
    ...
    public ResponseEntity<DetailSalesOrderResponse> getDetailSalesOrder(@PathVariable Long salesOrderId) {
    ...
    public ResponseEntity<UpdateSalesOrderResponse> updateSalesOrder(
            @PathVariable Long salesOrderId, @RequestBody UpdateSalesOrderRequest request) {
    ...
    public ResponseEntity<DeleteSalesOrderResponse> deleteSalesOrder(@PathVariable Long salesOrderId) {
