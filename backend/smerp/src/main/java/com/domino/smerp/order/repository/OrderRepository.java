...
public interface OrderRepository extends JpaRepository<Order, Long>, OrderQueryRepository {
    ...
    @Query("SELECT DISTINCT o FROM Order o " + "JOIN FETCH o.client "
            + "JOIN FETCH o.user "
    ...
    // delete 메소드 분리
    @Query("SELECT o FROM Order o " + "JOIN FETCH o.client " + "JOIN FETCH o.user " + "WHERE o.orderId = :id")
    ...
    @Query(
            value = "SELECT MAX(CAST(SUBSTRING_INDEX(o.document_no, '-', -1) AS UNSIGNED)) " + "FROM `order` o "
