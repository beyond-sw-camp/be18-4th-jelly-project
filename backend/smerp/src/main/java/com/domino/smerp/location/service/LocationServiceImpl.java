...
public class LocationServiceImpl implements LocationService {
    ...
    public LocationListResponse getUnFilledLocations(final Long warehouseId) {
        ...
        List<Location> unFilledLocations = locationRepository.findAllByWarehouseIdAndFilledFalse(warehouseId);
        ...
        return LocationListResponse.builder().locationResponses(responses).build();
    }
    ...
    public LocationIdListResponse fillLocations(final LocationIdListRequest locationIdListRequest) {
        ...
        LocationIdListResponse locationIdListResponse =
                LocationIdListResponse.builder().build();
