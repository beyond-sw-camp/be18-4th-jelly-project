...
public class ItemQueryRepositoryImpl implements ItemQueryRepository {
    ...
    private BooleanExpression groupName1Contains(String groupName1) {
        return (groupName1 == null || groupName1.isEmpty()) ? null : QItem.item.groupName1.contains(groupName1);
    }

    // 품목 품목그룹2 검색
    private BooleanExpression groupName2Contains(String groupName2) {
        return (groupName2 == null || groupName2.isEmpty()) ? null : QItem.item.groupName2.contains(groupName2);
    }

    // 품목 품목그룹3 검색
    private BooleanExpression groupName3Contains(String groupName3) {
        return (groupName3 == null || groupName3.isEmpty()) ? null : QItem.item.groupName3.contains(groupName3);
    }
}
