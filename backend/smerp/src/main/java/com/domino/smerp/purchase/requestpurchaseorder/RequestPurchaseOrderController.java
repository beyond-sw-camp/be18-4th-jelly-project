...
public class RequestPurchaseOrderController {
    ...
    public ResponseEntity<PageResponse<RequestPurchaseOrderGetListResponse>> getRequestPurchaseOrders(
            @ModelAttribute SearchRequestPurchaseOrderRequest keyword, Pageable pageable) {
        return ResponseEntity.ok(requestPurchaseOrderService.searchRequestPurchaseOrders(keyword, pageable));
    }

    // ✅ 구매요청 상세 조회
    @GetMapping("/{rpoId}")
    public ResponseEntity<RequestPurchaseOrderGetDetailResponse> getRequestPurchaseOrderById(@PathVariable Long rpoId) {
    ...
    public ResponseEntity<RequestPurchaseOrderUpdateResponse> updateRequestPurchaseOrder(
            @PathVariable Long rpoId, @RequestBody RequestPurchaseOrderUpdateRequest request) {
        RequestPurchaseOrderUpdateResponse response =
                requestPurchaseOrderService.updateRequestPurchaseOrder(rpoId, request);
        return ResponseEntity.ok(response);
    }

    // ✅ 구매요청 삭제 (소프트 삭제)
    @DeleteMapping("/{rpoId}")
    public ResponseEntity<RequestPurchaseOrderDeleteResponse> deleteRequestPurchaseOrder(@PathVariable Long rpoId) {
