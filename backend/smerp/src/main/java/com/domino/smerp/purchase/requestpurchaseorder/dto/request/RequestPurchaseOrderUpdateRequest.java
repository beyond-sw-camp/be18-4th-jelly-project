...
public class RequestPurchaseOrderUpdateRequest {
    @NotNull(message = "일자는 필수 입력입니다.") private final LocalDate newDocDate; // 전표번호 변경용 날짜

    @NotNull(message = "납기일자는 필수 입력입니다.") private final LocalDate deliveryDate; // 납기 요청일자
